...
public class Settings extends Profile {
    ...
    public static final String API = "https://api.grustnogram.ru";
    public static final String MSG_GRUSTNOGRAM_RU = "https://msg.grustnogram.ru";
